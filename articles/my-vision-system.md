...
全体的にシンプルな構成を保ちつつ、フロントエンドでは一部 Astro を使ったり、AI Agents のワークフロー管理で Prefect を導入したりなど、新しい技術も取り入れています。
...
現在、リモート環境を staging 以外に作ったりデプロイフローを整えており、リリースの高速化を目指し GitHub Flow に移行準備中です。
